...
var _recommendationCard = require('./recommendation-card');

var _recommendationCard2 = _interopRequireDefault(_recommendationCard);

var _recommendationsService = require('../services/recommendations-service');

var _recommendationsService2 = _interopRequireDefault(_recommendationsService);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function recommendationItemFactory(DOM) {
  return function (item) {
    return (0, _recommendationCard2.default)({ DOM: DOM, props$: _rx.Observable.of(item) });
  };
}

function model(props$) {
  return props$.flatMapLatest(function (props) {
    return _rx.Observable.fromPromise((0, _recommendationsService2.default)(props.targetUrl.hostname));
  ...
  .map(function (result) {
    ...
    var findSource = function findSource(s, id) {
      return s.find(function (item) {
        return item.source_id === id;
      });
    };
    feed.forEach(function (item) {
      var source = findSource(sources, item.content.source_id);
...
function view(state$, DOM) {
  return state$.map(function (data) {
    return (0, _dom.div)('.recommendations-box', [(0, _dom.ul)('.recommendations-list', data.map(function (item) {
      return (0, _dom.li)('.recommendations-list-item', [recommendationItemFactory(DOM)(item).DOM]);
    }))]);
  });
}
...
},{"../services/recommendations-service":10,"./recommendation-card":4,"@cycle/dom":13,"@cycle/isolate":70,"rx":73}],2:[function(require,module,exports){
'use strict';
...
var _metricService = require('../services/metric-service');
...
function intent(DOM) {
  var homeLink = DOM.select('.link');
  return {
    homeLinkClick$: homeLink.events('click')
  };
}

function view(props$) {
  return props$.map(function (data) {
    return (0, _dom.div)('.header', [(0, _dom.h1)('.header-primary', '404'), (0, _dom.h2)('.header-secondary', 'Страница не найдена'), (0, _dom.p)('.header-description', ['К сожалению, такой страницы нет на данном сайте. ', 'Возможно, вы ввели неправильный адрес', (0, _dom.br)(), 'или страница была удалена с сервера. ', 'Можете перейти на ', (0, _dom.a)('.link', { href: data.targetUrl.origin }, data.targetUrl.origin), '.'])]);
  });
}
...
function main(_ref) {
  ...
  actions.homeLinkClick$.subscribe(function () {
    return (0, _metricService2.default)({ element: 'main_site' });
  });
...
},{"../services/metric-service":8,"@cycle/dom":13,"@cycle/isolate":70}],3:[function(require,module,exports){
'use strict';
...
var _popularSearchesService = require('../services/popular-searches-service');

var _popularSearchesService2 = _interopRequireDefault(_popularSearchesService);
...
function intent(DOM) {
  var link = DOM.select('.popular-searches-link');
  return {
    popularSearchesClick$: link.events('click')
  };
}

function model() {
  return _rx.Observable.fromPromise((0, _popularSearchesService2.default)('error404'));
}

function view(state$) {
  return state$.map(function (data) {
    return (0, _dom.div)('.popular-searches', ['Например, ', (0, _dom.a)('.popular-searches-link', { href: data.href }, [data.text])]);
  });
}
...
function main(_ref) {
  ...
  actions.popularSearchesClick$.subscribe(function () {
    return (0, _metricService2.default)({ element: 'search_example_click' });
  });
...
},{"../services/metric-service":8,"../services/popular-searches-service":9,"@cycle/dom":13,"@cycle/isolate":70,"rx":73}],4:[function(require,module,exports){
'use strict';
...
function intent(DOM) {
  var link = DOM.select('.recommendations-card-link');
  return {
    click$: link.events('click').map(function (e) {
...
function model(props$) {
  return props$.map(function (data) {
    var result = {
      preview: data.content.pictures[0].preview,
      title: data.content.title,
      snippet: data.content.snippet,
      url: data.content.url,
      redirectUrl: data.content.redirect_url
    };
...
function view(state$) {
  return state$.map(function (data) {
    return (0, _dom.div)('.recommendations-card', [(0, _dom.a)('.recommendations-card-link', { href: data.url }, [(0, _dom.img)('.recommendations-card-preview', { src: data.preview }), data.title !== '' ? (0, _dom.header)('.recommendations-card-header', data.title) : null, (0, _dom.article)('.recommendations-card-description', data.snippet), data.source ? (0, _dom.div)('.recommendations-card-source', [(0, _dom.p)('.recommendations-card-source-title', [data.source.title]), (0, _dom.img)('.recommendations-card-source-image', { src: data.source.image })]) : null])]);
  });
}
...
function main(_ref) {
  ...
  actions.click$.subscribe(function (data) {
    return (0, _metricService2.default)({ element: 'like_site', url_site: encodeURIComponent(data) });
  });
...
},{"../services/metric-service":8,"@cycle/dom":13,"@cycle/isolate":70}],5:[function(require,module,exports){
'use strict';
...
var _popularSearches = require('./popular-searches');

var _popularSearches2 = _interopRequireDefault(_popularSearches);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function intent(DOM) {
  var input = DOM.select('.search-form-input');
  return {
    focusIn$: input.events('focusin').map(function (e) {
      return true;
    }),
    focusOut$: input.events('focusout').map(function (e) {
      return false;
    }),
    change$: input.events('input').map(function (e) {
...
function model(actions, props$) {
  return _rx.Observable.combineLatest(_rx.Observable.merge(actions.focusIn$, actions.focusOut$).startWith(false), actions.change$.startWith(''), props$).map(function (results) {
    return {
      focused: results[0],
      isEmpty: results[1] === '',
      props: results[2]
...
function view(state$, popularSearchesVtree$) {
  return state$.map(function (state) {
    return (0, _dom.div)('.search', [(0, _dom.form)('.search-form' + (state.focused ? '.search-form__focused' : ''), { method: 'GET', action: 'http://go.mail.ru/search' }, [(0, _dom.input)({ type: 'hidden', value: 'error404', name: 'fr' }), (0, _dom.input)({ type: 'hidden', value: state.props.gp, name: 'gp' }), (0, _dom.input)('.search-form-input', { type: 'search', name: 'q', placeholder: 'Поиск в интернете' }), (0, _dom.button)('.search-form-submit', { type: 'submit' }, [(0, _dom.i)('.search-form-submit-icon')])]), (0, _dom.div)('.search-popular-searches-container' + (state.isEmpty ? '' : '.hidden'), popularSearchesVtree$)]);
  });
}
...
function main(_ref) {
  ...
  var popularSearchesBox = (0, _popularSearches2.default)({ DOM: DOM });

  var actions = intent(DOM);
  var state$ = model(actions, props$);
  var vtree$ = view(state$, popularSearchesBox.DOM);
...
},{"./popular-searches":3,"@cycle/dom":13,"@cycle/isolate":70,"rx":73}],6:[function(require,module,exports){
'use strict';
...
function main(_ref) {
  ...
  var headerBox = (0, _header2.default)({ DOM: DOM, props$: props$ });
  var searchBox = (0, _search2.default)({ DOM: DOM, props$: props$ });
  var feedBox = (0, _feed2.default)({ DOM: DOM, props$: props$ });

  var headerVtree$ = headerBox.DOM;
  var searchVtree$ = searchBox.DOM;
  var feedVtree$ = feedBox.DOM;

  var vtree$ = _rx.Observable.combineLatest(headerVtree$, searchVtree$, feedVtree$).map(function (components) {
    return (0, _dom.div)('.app', components);
  });
...
_core2.default.run(main, {
  ...
  props$: function props$() {
    return _rx.Observable.combineLatest(_rx.Observable.just({ targetUrl: new URL(window.location.search.replace('?target_url=', '')) }), _rx.Observable.fromPromise((0, _chromeUtils.wrapChromeApi)(chrome.runtime, 'sendMessage', { type: 'get_extension_data' })), function (props, extensionData) {
      return _extends({}, props, extensionData);
    });
  }
});

},{"./components/feed":1,"./components/header":2,"./components/search":5,"./utils/chrome-utils":11,"@cycle/core":12,"@cycle/dom":13,"rx":73}],7:[function(require,module,exports){
'use strict';
...
function sendMessage(message) {
  return (0, _chromeUtils.wrapChromeApi)(chrome.runtime, 'sendMessage', message);
}

},{"../utils/chrome-utils":11}],8:[function(require,module,exports){
'use strict';
...
function sendMetric(parameters) {
  return (0, _messageService2.default)({ type: 'metric', data: _extends({ type: 'error404' }, parameters) });
}

},{"./message-service":7}],9:[function(require,module,exports){
"use strict";
...
exports.default = function (fr) {
  var PATTERN = /\s*<a href="(.+)" .+>(.+)<\/a>/gi;

  return fetch("http://ad.mail.ru/adi/1121?_SITEZONE=1&fr=" + fr).then(function (response) {
    return response.text();
  }).then(function (response) {
    var _PATTERN$exec = PATTERN.exec(response);

    var _PATTERN$exec2 = _slicedToArray(_PATTERN$exec, 3);

    var href = _PATTERN$exec2[1];
    var text = _PATTERN$exec2[2];
...
exports.default = function (query) {
  ...
  if (savedSession) {
    return getRecommendations(query, savedSession, COUNT);
  }

  return login().then(function (loginResult) {
    var newSession = loginResult.session;
    setSession(newSession);
    return getRecommendations(query, newSession, COUNT);
  });
};

var COUNT = 6;
var STORAGE_KEY = 'recommendation_session';
var API_URL = 'https://stepan-fe.go.mail.ru/web';

function login() {
  return fetch(API_URL + '?stepan=t&query_type=login&no_cookies=1').then(function (response) {
    return response.json();
  });
}

function getRecommendations(query, session) {
  var count = arguments.length <= 2 || arguments[2] === undefined ? 3 : arguments[2];

  return fetch(API_URL + '?stepan=t&no_cookies=1&query_type=recommend_search&session=' + encodeURIComponent(session) + '&n=' + count + '&q=' + encodeURIComponent(query)).then(function (response) {
    return response.json();
  });
}
...
function setSession(session) {
  return localStorage.setItem(STORAGE_KEY, session);
}
...
},{"rx":73}],13:[function(require,module,exports){
"use strict";
 ...
 */
},{"./mock-dom-source":15,"./render-dom":16,"./render-html":17,"./virtual-hyperscript":20,"./virtual-hyperscript-svg":19,"hyperscript-helpers":21}],14:[function(require,module,exports){
"use strict";
...
},{"rx":73}],15:[function(require,module,exports){
'use strict';
...
},{"rx":73}],16:[function(require,module,exports){
"use strict";
...
},{"./fromevent":14,"./transposition":18,"./virtual-hyperscript":20,"matches-selector":22,"rx":73,"vdom-parser":23,"virtual-dom/diff":38,"virtual-dom/patch":45}],17:[function(require,module,exports){
"use strict";
...
},{"./transposition":18,"rx":73,"vdom-to-html":27}],18:[function(require,module,exports){
"use strict";
...
},{"rx":73,"virtual-dom/vnode/vnode":64}],19:[function(require,module,exports){
/*eslint-disable */
'use strict';
...
// END Cycle.js-specific code <<<<<<<<<<
},{"./virtual-hyperscript":20,"virtual-dom/virtual-hyperscript/hooks/attribute-hook":52,"virtual-dom/virtual-hyperscript/svg-attribute-namespace":56,"x-is-array":69}],20:[function(require,module,exports){
/* eslint-disable */
'use strict';
...
/* eslint-enable */
},{"virtual-dom/virtual-hyperscript/hooks/ev-hook.js":53,"virtual-dom/virtual-hyperscript/hooks/soft-set-hook.js":54,"virtual-dom/virtual-hyperscript/parse-tag.js":55,"virtual-dom/vnode/is-thunk":58,"virtual-dom/vnode/is-vhook":59,"virtual-dom/vnode/is-vnode":60,"virtual-dom/vnode/is-vtext":61,"virtual-dom/vnode/is-widget":62,"virtual-dom/vnode/vnode.js":64,"virtual-dom/vnode/vtext.js":66,"x-is-array":69}],21:[function(require,module,exports){
'use strict';
...
},{"./namespace-map":24,"./property-map":25,"virtual-dom/vnode/vnode":64,"virtual-dom/vnode/vtext":66}],24:[function(require,module,exports){
...
},{"./property-config":36,"escape-html":28}],27:[function(require,module,exports){
var escape = require('escape-html');
...
},{"./create-attribute":26,"./void-elements":37,"escape-html":28,"param-case":34,"virtual-dom/virtual-hyperscript/hooks/attribute-hook":52,"virtual-dom/virtual-hyperscript/hooks/soft-set-hook":54,"virtual-dom/vnode/is-thunk":58,"virtual-dom/vnode/is-vnode":60,"virtual-dom/vnode/is-vtext":61,"virtual-dom/vnode/is-widget":62,"xtend":35}],28:[function(require,module,exports){
/*!
 * escape-html
...
},{"./vendor/camel-case-regexp":31,"./vendor/non-word-regexp":32,"./vendor/trailing-digit-regexp":33,"lower-case":29}],31:[function(require,module,exports){
...
},{"sentence-case":30}],35:[function(require,module,exports){
...
},{"./vtree/diff.js":68}],39:[function(require,module,exports){
/*!
...
},{"min-document":71}],44:[function(require,module,exports){
"use strict";
...
},{"../vnode/is-vhook.js":59,"is-object":44}],47:[function(require,module,exports){
...
},{"../vnode/handle-thunk.js":57,"../vnode/is-vnode.js":60,"../vnode/is-vtext.js":61,"../vnode/is-widget.js":62,"./apply-properties":46,"global/document":43}],48:[function(require,module,exports){
...
},{"../vnode/is-widget.js":62,"../vnode/vpatch.js":65,"./apply-properties":46,"./update-widget":51}],50:[function(require,module,exports){
var document = require("global/document")
var isArray = require("x-is-array")
...
},{"./create-element":47,"./dom-index":48,"./patch-op":49,"global/document":43,"x-is-array":69}],51:[function(require,module,exports){
var isWidget = require("../vnode/is-widget.js")
...
},{"../vnode/is-widget.js":62}],52:[function(require,module,exports){
'use strict';
...
},{"browser-split":39}],56:[function(require,module,exports){
'use strict';
