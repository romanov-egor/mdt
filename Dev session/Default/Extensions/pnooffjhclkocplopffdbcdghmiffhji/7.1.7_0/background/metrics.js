...
function getGoMetricUrl() {
	...
	// for compatibility
	return addUrlParams("http://go.mail.ru/distib/mark/?variation=vbmdf&product_id={" + productId + "}", getCommonParams());
}
...
function getMrdsMetricUrl() {
	...
	// for compatibility
	url = addUrlParams(
		"http://mrds.mail.ru/update/2/version.txt?variation=vbmdf&type=product_online_metric&product_id={" + productId + "}",
		getCommonParams());
