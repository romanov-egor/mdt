...
registration will fail, but the configuration of your web app will remain functional.
...
For environments using [Node](https://nodejs.org/), the easiest way to handle this would be to install [serve](https://github.com/zeit/serve) and let it handle the configuration:
